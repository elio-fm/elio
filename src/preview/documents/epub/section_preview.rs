use super::super::{
    xml_parsing::{local_name, xml_attribute_value},
    zip_reading::{read_zip_entry_limited, resolve_zip_entry_path},
};
use super::{
    EPUB_CONTENT_ENTRY_LIMIT_BYTES, EPUB_SECTION_IMAGE_ENTRY_LIMIT_BYTES,
    EPUB_SECTION_TEXT_LIMIT_CHARS, append_epub_text_fragment,
    image_extraction::{ExtractedEpubAsset, extract_epub_asset},
};
...
pub(super) struct EpubSectionPreview {
    pub(super) text: String,
    pub(super) truncation_note: Option<String>,
    pub(super) visual: Option<PreviewVisual>,
}

pub(super) fn extract_epub_section_preview<R: Read + std::io::Seek>(
    source_path: &Path,
...
pub(super) fn build_preview_visual(
