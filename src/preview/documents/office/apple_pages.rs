use super::super::{
    metadata_formatting::first_present_string, metadata_preview::DocumentMetadata,
    xml_parsing::local_name, zip_reading::read_zip_entry,
};
use quick_xml::{Reader, events::Event};
use std::{collections::BTreeMap, io::Read};
use zip::ZipArchive;

pub(in crate::preview::documents) fn extract_apple_pages_metadata<R: Read + std::io::Seek>(
