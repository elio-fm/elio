use super::super::{
    metadata_formatting::{present_count, present_string, push_count_stat},
    metadata_preview::DocumentMetadata,
    xml_parsing::parse_xml_text_fields,
    zip_reading::read_zip_entry,
};
use crate::file_classification::DocumentFormat;
use std::io::{Read, Seek};
use zip::ZipArchive;

pub(in crate::preview::documents) fn extract_microsoft_office_metadata<R: Read + std::io::Seek>(
