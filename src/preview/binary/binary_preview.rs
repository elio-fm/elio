...
pub(super) struct BinaryMetadata {
    ...
    pub(super) bits: Option<&'static str>,
    pub(super) endianness: Option<&'static str>,
    pub(super) abi: Option<String>,
    pub(super) subsystem: Option<String>,
    pub(super) entry_point: Option<String>,
    pub(super) section_count: Option<usize>,
    pub(super) command_count: Option<usize>,
}
...
pub(in crate::preview) fn build_binary_preview(
    path: &Path,
