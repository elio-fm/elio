use super::super::archive_formats::ArchiveFormat;
use super::super::archive_preview::{ZIP_BUILT_IN_READER_MAX_BYTES, build_archive_preview};
use super::{
...
#[test]
fn oversized_cbz_skips_built_in_zip_reader() {
    let root = temp_path("oversized-cbz-reader-skip");
    fs::create_dir_all(&root).expect("failed to create temp root");
