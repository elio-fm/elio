use super::archive_cache::load_comic_archive;
use super::archive_reading::{CachedComicArchive, has_rar_capable_extractor};
use super::page_extraction::extract_comic_archive_page_visual;
use crate::preview::archives::archive_formats::{ArchiveFormat, archive_default_label};
use crate::preview::archives::archive_rendering::push_preview_section;
use crate::preview::{PreviewContent, PreviewKind, appearance as theme};
use ratatui::text::Line;
use std::path::Path;

pub(in crate::preview::archives) fn build_comic_archive_preview<F>(
    path: &Path,
