...
fn render_document_preview_lines(metadata: &DocumentMetadata) -> Vec<Line<'static>> {
...
fn read_zip_entry_limited<R: Read + std::io::Seek>(
    archive: &mut ZipArchive<R>,
    name: &str,
    limit_bytes: usize,
) -> Option<String> {
...
fn resolve_zip_entry_path(base_path: &str, href: &str) -> String {
...
fn strip_fragment_identifier(path: &str) -> &str {
