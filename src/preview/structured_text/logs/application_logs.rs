use super::log_types::{LogSource, ParsedLogDocument, ParsedLogEntry, RawLogEntry};

pub(super) fn parse_application_log_document(text: &str) -> Option<ParsedLogDocument> {
