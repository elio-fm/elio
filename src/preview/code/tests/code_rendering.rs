...
fn enabled_javascript_preview_specs_use_syntect() {
    ...
    let expected = syntect_highlighting::render_syntect_code_preview(
        "javascript",
        "const value = 1;\n",
        true,
        20,
...
fn enabled_generic_source_preview_specs_use_syntect() {
    for (code_syntax, text) in [
        ...
        let expected =
            syntect_highlighting::render_syntect_code_preview(code_syntax, text, true, 20, &|| {
                false
            })
...
fn unsupported_syntect_specs_still_fall_back_to_plain_rendering() {
    ...
    let expected = plain_code::render_plain_code_preview("still plain\n", true, 20, &|| false);
...
fn custom_preview_specs_use_custom_backend() {
    ...
    let expected = built_in_highlighting::render_built_in_code_preview(
...
fn unknown_syntect_preview_specs_fall_back_to_plain_text() {
    ...
    let expected = plain_code::render_plain_code_preview(text, true, 20, &|| false);
