...
#[path = "../built_in_highlighting/tests/preview_rendering.rs"]
mod built_in_previews;
mod language_previews;
#[path = "../built_in_highlighting/tests/shell_scripts.rs"]
mod shell_previews;
#[path = "../syntect_highlighting/tests/language_previews.rs"]
mod syntect_previews;
