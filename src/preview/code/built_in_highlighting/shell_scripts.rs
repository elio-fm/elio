...
use crate::preview::code::highlighting_styles::{SemanticRole, role_color};
use ratatui::{
...
pub(in crate::preview::code) fn render_shell_script<F>(
    text: &str,
    line_numbers: bool,
    line_limit: usize,
    canceled: &F,
...
pub(in crate::preview::code) fn is_shell_syntax(code_syntax: &str) -> bool {
