#[path = "highlighting/brace_like.rs"]
mod brace_like;
#[path = "highlighting/cmake.rs"]
mod cmake;
#[path = "highlighting/common.rs"]
mod common;
#[path = "highlighting/data.rs"]
mod data;
#[path = "highlighting/js_like.rs"]
mod js_like;
#[path = "highlighting/logs.rs"]
mod logs;
#[path = "highlighting/make.rs"]
mod make;
#[path = "highlighting/markup.rs"]
mod markup;
#[path = "highlighting/nix.rs"]
mod nix;
#[path = "highlighting/python.rs"]
mod python;
#[path = "highlighting/shell.rs"]
mod shell;
#[cfg(test)]
#[path = "highlighting/tests.rs"]
mod tests;

use crate::{appearance, file_facts::HighlightLanguage};
use ratatui::{
    style::Style,
    text::{Line, Span},
};
