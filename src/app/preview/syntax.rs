...
fn build_code_theme() -> Theme {
    ...
    Theme {
        ...
        scopes: vec![
            ...
            theme_item(
                "string, meta.interpolation, punctuation.definition.string",
                Some(preview.string),
                None,
                None,
            ),
            theme_item(
                "constant.numeric, constant.language, constant.character.escape, constant.other, support.constant, variable.language",
            ...
            theme_item(
                "entity.name.function, entity.name.function.method, support.function, support.function.builtin, support.function.magic, meta.function-call, meta.function variable.other, meta.method-call variable.function, variable.function",
                Some(preview.function),
                None,
                None,
            ),
            theme_item(
                "entity.name.type, entity.name.class, entity.name.namespace, entity.name.type.class, support.type, support.class",
                Some(preview.r#type),
                None,
                None,
            ),
            theme_item(
                "variable.parameter, meta.function.parameters variable.other, meta.function.arguments variable.other, entity.other.attribute-name, support.type.property-name, meta.attribute-with-value entity.other.attribute-name",
            ...
            theme_item(
                "keyword.operator, punctuation.definition.tag, punctuation.separator.key-value, punctuation.separator.attribute-value, punctuation.definition.parameters, punctuation.definition.arguments",
                Some(preview.operator),
                None,
                None,
            ),
            theme_item(
                "entity.name.function.preprocessor, entity.name.function.decorator, support.function.macro, meta.annotation, punctuation.definition.annotation",
