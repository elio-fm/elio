...
pub(super) fn render_markdown_preview(text: &str) -> Vec<Line<'static>> {
    let mut renderer = MarkdownRenderer::new(appearance::palette());
...
impl MarkdownRenderer {
    fn new(palette: appearance::Palette) -> Self {
        Self {
            palette,
            lines: Vec::new(),
            current: Vec::new(),
...
fn heading_style(level: HeadingLevel, palette: appearance::Palette) -> Style {
