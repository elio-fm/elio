...
impl App {
    ...
    pub(in crate::app::preview) fn cached_sixel_dcs(&self, key: &SixelDcsKey) -> Option<Arc<[u8]>> {
    ...
    pub(in crate::app::preview) fn remember_sixel_dcs(&mut self, key: SixelDcsKey, dcs: Arc<[u8]>) {
        self.preview
            .image
            .sixel_dcs_payloads
