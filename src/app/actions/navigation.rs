...
use crate::file_browser::{DirectoryHistoryMode, DirectoryLoadCompletion, ViewMode};
use crate::file_classification::{self, FileClass};
use crate::filesystem::Entry;
use crate::preview::{PreviewContent, PreviewRefreshMode, PreviewWorkClass, preview_work_class};
use anyhow::Result;
use std::{
    path::{Path, PathBuf},
    time::Instant,
