...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) enum TerminalImageBackend {
    KittyProtocol,
    Kitten,
}
...
impl App {
    ...
    pub(super) fn cached_terminal_window(&self) -> Option<TerminalWindowSize> {
...
pub(super) fn detect_terminal_image_backend() -> Option<TerminalImageBackend> {
...
pub(super) fn place_terminal_image(
...
pub(super) fn clear_terminal_images(backend: TerminalImageBackend) -> Result<()> {
    match backend {
